    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 mx-auto"
                ...
                <form method="POST" action="{{ route('reservas.update', $reserva->id)}}" class="mx-auto">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="fecha_reserva" id="fecha_reserva" value="{{ $reserva->fecha_reserva }}"
                    ...
                    <input type="text" name="comentario" id="comentario" value= "{{ $reserva->comentario }}"
